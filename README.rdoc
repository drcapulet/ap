= AP - Associated Press API Gem http://http://travis-ci.org/drcapulet/ap.png

This is a Ruby API wrapper the the Assosciated Press API v2. This code was based on version 1.1 of the documentation, which was last revised 06/15/2010
